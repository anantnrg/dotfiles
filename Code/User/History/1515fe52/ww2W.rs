            ...
            Event::WindowEvent {
                ...
                match event {
                    ...
                    WindowEvent::RedrawRequested => {
                        ...
                        let ellipse = Ellipse::new((250.0, 420.0), (100.0, 160.0), 50.0);
                        let ellipse_fill_color = Color::rgb(0.7961, 0.651, 0.9686);

                        let line = Line::new((60.0, 60.0), (156.0, 156.0));
                        let line_fill_color = Color::rgb(0.5373, 0.7059, 0.9804);
                        ...
                        scene.stroke(&rect_stroke, Affine::IDENTITY, line_fill_color, None, &line);
