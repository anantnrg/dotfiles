            ...
            Event::WindowEvent {
                ...
                match event {
                    ...
                    WindowEvent::RedrawRequested => {
                        ...
                        // Create some shapes!
                        let rect = RoundedRect::new(10.0, 10.0, 200.0, 200.0, 20.0);
                        let rect_stroke = Stroke::new(2.0);
                        let rect_stroke_color = Color::rgb(243.0, 139.0, 168.0);

                        let circle = Circle::new((300.0, 300.0), 160.0);
                        let circle_fill_color = Color::rgb(250.0, 179.0, 135.0);
