import type { Logger, PlaybackStatus } from '@motion-canvas/core/src/app';
import type { SubscribableEvent, SubscribableValueEvent, ValueDispatcher } from '@motion-canvas/core/src/events';
import type { Plugin } from '@motion-canvas/core/src/plugin';
import type { SignalValue } from '@motion-canvas/core/src/signals';
import type { Vector2 } from '@motion-canvas/core/src/types';
import type { LifecycleEvents } from '@motion-canvas/core/src/scenes/LifecycleEvents';
import type { Random } from '@motion-canvas/core/src/scenes/Random';
import type { SceneMetadata } from '@motion-canvas/core/src/scenes/SceneMetadata';
import type { Slides } from '@motion-canvas/core/src/scenes/Slides';
import type { Variables } from '@motion-canvas/core/src/scenes/Variables';
import type { TimeEvents } from '@motion-canvas/core/src/scenes/timeEvents';
/**
