...
impl Volt {
    pub fn new() -> Self {
        ...
        let root_div_node = tree.new_leaf(Style {size: Size::from_percent(100.0, 100.0),..Default::default()});
        let root = tree.new_with_children(Style {..Default::default()}, children);
        Volt {
            renderers: vec![],
            root: Div::default(),
        }
