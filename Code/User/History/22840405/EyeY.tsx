...
export default makeScene2D(function* (view) {
    ...
    yield* break_loop_icon().scale(0, 0.75, easeInOutQuad);
    yield* closeWindowScale(while_loop_button_ref);
    yield* closeWindowScale(value_button_ref);
    yield* closeWindowScale(function_button_ref);
    yield* value_to_loop_arrow_ref().opacity(1, 0.55);
});
