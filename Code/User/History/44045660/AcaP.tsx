...
export default makeScene2D(function* (view) {
  ...
  const subCurve_text = createRef<Txt>();
  ...
  yield* chain(
    ...
    tween(0.75, (v) => {
      ...
      subCurve_text().opacity(map(0, 1, easeInOutCubic(v)));
    }),
  );

  yield* all(
    subCurve().y(180, 1, easeInOutCubic),
    subCurve_text().y(380, 1, easeInOutCubic),
  );

  yield* all(
    subCurve().y(200, 1, easeInOutCubic),
    subCurve_text().y(400, 1, easeInOutCubic),
  );
