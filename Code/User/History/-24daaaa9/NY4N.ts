import type { ThreadGenerator } from '@motion-canvas/core/src/threading';
import type { InterpolationFunction, TimingFunction } from '@motion-canvas/core/src/tweening';
