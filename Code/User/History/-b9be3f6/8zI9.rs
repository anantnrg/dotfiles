    ...
    rsx! {
        rect {
            ...
            rect { width: "100%", height: "100%", direction: "vertical",
                ...
                HorizontalSeparator { colors: colors.separator.clone(), interactive: true, reverse: true }
                Editor { colors: colors.editor.clone() }
                HorizontalSeparator { colors: colors.separator.clone(), interactive: true, reverse: false }
