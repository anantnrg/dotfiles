...
impl Default for Functions {
    fn default() -> Self {
        Functions {
            default: Style::normal(MOCHA.text),
            builtin: Style::normal(MOCHA.text),
            call: Style::normal(MOCHA.text),
            macro_: Style::normal(MOCHA.text),
            method: Style::normal(MOCHA.text),
            method_call: Style::normal(MOCHA.text),
            constructor: Style::normal(MOCHA.text),
