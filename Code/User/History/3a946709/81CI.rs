...
impl Style {
    ...
    pub fn inverted(color: &'static str) -> Self {
        Style {
            background,
            color: "rgb(30, 29, 45)",
            weight: "normal",
...
impl Default for Comments {
    fn default() -> Self {
        Comments {
            ...
            error: Style::normal(MOCHA.text),
            warning: Style::normal(MOCHA.text),
            todo: Style::normal(MOCHA.text),
            note: Style::normal(MOCHA.text),
        }
    }
}
