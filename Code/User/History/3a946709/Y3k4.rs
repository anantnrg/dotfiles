    ...
    fn default() -> Self {
        Literals {
            strings: Strings {
                ...
                docs: Style::normal(MOCHA.text),
                regexp: Style::normal(MOCHA.text),
                escape: Style::normal(MOCHA.text),
                special: Style::normal(MOCHA.text),
                special_symbol: Style::normal(MOCHA.text),
                special_url: Style::normal(MOCHA.text),
                special_path: Style::normal(MOCHA.text),
            },
            characters: Characters {
                default: Style::normal(MOCHA.text),
                special: Style::normal(MOCHA.text),
            },
            boolean: Style::normal(MOCHA.text),
            number: Style::normal(MOCHA.text),
            float: Style::normal(MOCHA.text),
        }
    }
}
