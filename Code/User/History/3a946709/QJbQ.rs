...
impl Default for Keywords {
    fn default() -> Self {
        Keywords {
            default: Style::normal(MOCHA.text),
            coroutine: Style::normal(MOCHA.text),
            function: Style::normal(MOCHA.text),
            operator: Style::normal(MOCHA.text),
            import: Style::normal(MOCHA.text),
            storage: Style::normal(MOCHA.text),
            repeat: Style::normal(MOCHA.text),
            return_: Style::normal(MOCHA.text),
            debug: Style::normal(MOCHA.text),
            exception: Style::normal(MOCHA.text),
            conditional: Style::normal(MOCHA.text),
            conditional_ternary: Style::normal(MOCHA.text),
            directive: Style::normal(MOCHA.text),
            directive_define: Style::normal(MOCHA.text),
        }
    }
}
