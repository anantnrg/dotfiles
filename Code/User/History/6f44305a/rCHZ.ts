import type { Scene, SceneDescriptionReload, Slide } from '@motion-canvas/core/src/scenes';
...
export declare class PlaybackManager {
     ...
     * @eventProperty
     */
    get onSceneChanged(): import("@motion-canvas/core/src/events").SubscribableValueEvent<Scene<unknown>>;
    /**
     ...
     * @eventProperty
     */
    get onScenesRecalculated(): import("@motion-canvas/core/src/events").SubscribableValueEvent<Scene<unknown>[]>;
    frame: number;
    speed: number;
    fps: number;
    duration: number;
