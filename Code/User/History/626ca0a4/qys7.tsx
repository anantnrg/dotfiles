...
export default makeScene2D(function* (view) {
    ...
    yield* chain(
        waitUntil("set-x-16"),
        codeblock().edit(0.55)`let mut x${edit(": i32\nx = 1;", " = 16")};\nprintln!("{}", x);`,
    );
    ...
    yield* chain(
        codeblock().edit(0.55)`let mut x: i32 = 16;${insert("\nx = x + 4;")}\nprintln!("{}", x);`,
        waitUntil("what-this-will-do-1"),
        codeblock().edit(0.55)`let mut x: i32 = 16;\nx = ${edit("x", "16")} + 4;\nprintln!("{}", x);`,
        waitFor(1),
        codeblock().edit(0.55)`let mut x: i32 = 16;\nx = ${edit("16", "x")} + 4;\nprintln!("{}", x);`,
        waitFor(0.5),
        tween(0, v => {
    ...
    yield* chain(
        ...
        codeblock().edit(0.55)`let ${remove("mut ")}x: i32 = 16;\nx = x - 4;\nprintln!("{}", x);`,
        waitFor(0.5),
