...
export default makeScene2D(function* (view) {
  ...
  yield* all(
    codeblockRect().scale(0, 0.75, easeInOutQuart),
    eitherRef().opacity(0, 0.75, easeInOutQuart),
    xmark().opacity(0, 0.75, easeInOutQuart),
    isDroppedRef().opacity(0, 0.75, easeInOutQuart),
  );
  ...
  yield* all(
    thx().opacity(1, 0.75, easeOutSine),
    thx().y(-350, 0.75, easeOutSine),
  );https://www.gravatar.com/avatar/a2b2834ef719fbd8493081c48cb8056c?s=64&d=robohash
  yield* subscribe().scale(1, 0.75, easeInOutQuart);
  yield* video().scale(1, 0.75, easeInOutQuart);
  yield* playlist().scale(1, 0.75, easeInOutQuart);

  yield* all(
    subCurve().opacity(1, 0.75, easeInOutQuart),
    subCurveText().opacity(1, 0.75, easeInOutQuart),
  );
