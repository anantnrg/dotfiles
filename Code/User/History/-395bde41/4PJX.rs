...
impl Color {
    ...
    pub fn into(self) -> Result<&'static str> {
        match self {
            Color::Hex(hex) => {
                ...
                if hex.len() != 6 && hex.len() != 3 && hex.len() != 8 {
                    ...
                    return Ok(format!("rgb{}{}{}", red, green, blue).as_str());
                } else if hex.len() == 6 {
                    ...
                    return Ok(format!("rgb{}{}{}{}", red, green, blue, alpha).as_str());
                }

                Ok(format!("rgb{}{}{}", 0, 0, 0).as_str())
            }
            Color::Rgb(red, green, blue) => Ok(format!("rgb{}{}{}", red, green, blue).as_str()),
            Color::Rgba(red, green, blue, alpha) => {
                Ok(format!("rgb{}{}{}{}", red, green, blue, alpha).as_str())
            }
        }
    }
}
