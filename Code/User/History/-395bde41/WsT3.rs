...
impl Colors {
    pub fn new() -> Self {
        Colors {
            background: String::Hex("#1e1d2d"),
            foreground: String::Hex("#cdd6f4"),
            line_numbers: LineNumberColors {
                line_numbers_bg: String::Hex("#1e1d2d"),
                line_numbers_fg: String::Hex("#6c7086"),
                line_numbers_added_fg: String::Hex("#a6e3a1"),
                line_numbers_edited_fg: String::Hex("#f9e2af"),
                line_numbers_deleted_fg: String::Hex("#f38ba8"),
            },
            sidebar: SidebarColors {
                background: String::Hex("#1e1d2d"),
                foreground: String::Hex("#cdd6f4"),
                tab_fg: String::Hex("#cdd6f4"),
                tab_bar_bg: String::Hex("#1e1d2d"),
                tab_bg: String::Hex("#1e1d2d"),
            },
        }
    }
    pub fn into(&self) {}
