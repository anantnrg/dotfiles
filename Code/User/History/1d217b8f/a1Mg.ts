import { ThreadGenerator } from '@motion-canvas/core/src/threading/ThreadGenerator';
/**
...
export declare class Thread {
     ...
     */
    readonly time: import("@motion-canvas/core/src/signals").SimpleSignal<number, void>;
    /**
     ...
     */
    next(): IteratorYieldResult<void | Promise<any> | import("@motion-canvas/core/src/threading/ThreadGenerator").Promisable<any> | ThreadGenerator> | IteratorReturnResult<void> | {
        value: null;
        done: boolean;
    };
    /**
