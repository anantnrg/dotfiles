...
export default makeScene2D(function* (view) {
    ...
    yield* closeWindowScale(infinite_loop_rect_ref);
    yield* closeWindowScale(while_loop_rect_ref);
    yield* closeWindowScale(for_loop_rect_ref);
    yield* closeWindowScale(if_statement_rect_ref);
});
