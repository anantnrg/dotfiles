    ...
    if interactive {
        ...
        rsx! {
            rect {
                ...
                onglobalclick,
                onmousedown,
                onmouseover: {to_owned![hover_anim]; move |_| {hover_anim.start(); platform.set_cursor(CursorIcon::ColResize)}},
                onmouseleave: {to_owned![hover_anim]; move |_| {hover_anim.reverse(); platform.set_cursor(CursorIcon::Default)}},
