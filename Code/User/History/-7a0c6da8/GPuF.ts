import { ValueDispatcher } from '@motion-canvas/core/src/events';
/**
...
export declare class MetaField<TSerializedValue, TValue extends TSerializedValue = TSerializedValue> {
     ...
     * @eventProperty
     */
    get onChanged(): import("@motion-canvas/core/src/events").SubscribableValueEvent<TValue>;
     ...
     * @eventProperty
     */
    get onDisabled(): import("@motion-canvas/core/src/events").SubscribableValueEvent<boolean>;
